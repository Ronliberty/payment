...
SECRET_KEY = 'django-insecure-sn&lcg3_q3lx*n4+&cgj=ksgl(erqs8om@pe++op5m0zb0^_2k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['flowpay.pythonanywhere.com']
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.messages.context_processors.messages',
                 'payment.context_processors.wallet_balance_processor',
            ],
        },
    },
]
...
EMAIL_HOST_USER = 'dantezmalusi254@gmail.com'  # Your Gmail address
EMAIL_HOST_PASSWORD = 'tktu obfs qrnw saou'  # App password if using 2FA
